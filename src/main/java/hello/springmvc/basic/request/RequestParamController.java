...
public class RequestParamController {
    ...
    public String modelAttributeV1(@ModelAttribute HelloData helloData){ //ModelAttribute - 객채로 파라미터를 받아서 자동 매칭이 가능하다
    ...
    public String modelAttributeV2(HelloData helloData){ //ModelAttribute - 객채로 파라미터를 받아서 자동 매칭이 가능하다
